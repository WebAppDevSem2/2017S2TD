...
<%
    ...
    Product currentProduct = ProductRepositoty.getProductByString(productId1);
...
<div class="container">
    <div class="shoes-grid">
        <h1 ><%=map.get("view.title")%></h1>  <h3>Search result for "<%=productId1%>"</h3>
        <div style="box-shadow: 10px 10px 5px #888888;"class="view-adjust banner-matter">
            <div class="col-md-5 banner-bag">
                ...
                <% } else {%>
                <img style="margin-top: 60px" class="img-responsive " src="images/<%=currentProduct.getProductId()%>.jpg" alt=" " />
                <%}%>
            ...
            <div class="col-md-7 banner-off">							
                ...
                <form name="addcartform">
                    ...
                    <input type="hidden" name="idproduct" value="<%=currentProduct.getProductId()%>">
